...
def test_keyed_subset_with_include_should_fail_with_correct_message():
    ...
    schema = "keyed/schema_keyed_subset_with_include.yaml"
    yaml = "keyed/data_keyed_subset_with_include_bad.yaml"
...
def test_keyed_subset_with_include_should_succeed():
    base_dir = "tests/fixtures/"
    schema = "keyed/schema_keyed_subset_with_include.yaml"
    yaml = "keyed/data_keyed_subset_with_include_good.yaml"
...
def test_keyed_any_with_include_should_fail_with_correct_message():
    base_dir = "tests/fixtures/"
    schema = "keyed/schema_keyed_any_with_include.yaml"
    yaml = "keyed/data_keyed_any_with_include_bad.yaml"
...
def test_keyed_any_with_include_should_succeed():
    base_dir = "tests/fixtures/"
    schema = "keyed/schema_keyed_any_with_include.yaml"
    yaml = "keyed/data_keyed_any_with_include_good.yaml"
    result = tc.run_validate(schema, yaml, base_dir)
    assert result
